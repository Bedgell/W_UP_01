...
When looking at the graph it is broken down into two separate player types. It shows the averages of pushups each type of player can do. It should also be noted the player pool form "Skill" players and "Line" players, is larger showing a larger graph.  
...
The data shows that skill players are more likely to be able to do more pushups on average. 
